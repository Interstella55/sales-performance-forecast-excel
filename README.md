...
- Calculations – KPI formulas and backend logic
- Pivot_Tables – Supporting pivot structure
- Quarter_Revenue – Forecast preparation
- Cleaned_Sales_Data – Power Query output
